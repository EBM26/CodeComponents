...
<head>
	...
	<title>Sales Letter Template</title>
	...
	<style>
		*{margin: 0; padding: 0; max-width: 100%; -webkit-backface-visibility: hidden;}
		...
		img{border: 0;}
		.container{margin: auto; padding: 0; width: 700px;}
		.clear{clear: both; height: 1px; line-height: 1px; margin-bottom: -1px; overflow: hidden;}
		.Lfloat{float: left;}
		.Rfloat{float: right;}
		a:link, a:visited, a:active{text-decoration: none; color: inherit;}
		.princeton-purple{color: #605da9;}
		.nucific-green{color: #00a79d;}
		.gundry-blue{color: rgb(39, 55, 122);}
		.probiotic-blue{color: #0080be;}
	</style>
		<!--[if lt IE 9]>
